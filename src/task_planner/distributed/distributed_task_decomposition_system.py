...
from task_planner.distributed.parallel_task_executor import ParallelTaskExecutor, DependencyGraph
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join(logs_dir, 'distributed_task_decomposition.log'))
    ]
)
